...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TransitionObjectRelation'
        db.create_table(u'workflows_transitionobjectrelation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='transition_object', null=True, to=orm['contenttypes.ContentType'])),
        ...
        db.send_create_signal(u'workflows', ['TransitionObjectRelation'])


    def backwards(self, orm):
        # Deleting model 'TransitionObjectRelation'
        db.delete_table(u'workflows_transitionobjectrelation')
    ...
    models = {
        ...
        u'workflows.transitionobjectrelation': {
            'Meta': {'ordering': "('-datetime', '-id')", 'object_name': 'TransitionObjectRelation'},
            'content_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'transition_object'", 'null': 'True', 'to': u"orm['contenttypes.ContentType']"}),
