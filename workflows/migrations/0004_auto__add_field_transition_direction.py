...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transition.direction'
        db.add_column(u'workflows_transition', 'direction',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transition.direction'
        db.delete_column(u'workflows_transition', 'direction')
    ...
    models = {
        ...
        u'workflows.transition': {
            'Meta': {'ordering': "['destination']", 'object_name': 'Transition'},
