...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Transition', fields ['destination', 'direction']
        db.create_unique(u'workflows_transition', ['destination_id', 'direction'])


    def backwards(self, orm):
        # Removing unique constraint on 'Transition', fields ['destination', 'direction']
        db.delete_unique(u'workflows_transition', ['destination_id', 'direction'])
    ...
    models = {
        ...
        u'workflows.transition': {
            'Meta': {'ordering': "['destination']", 'unique_together': "(('destination', 'direction'),)", 'object_name': 'Transition'},
